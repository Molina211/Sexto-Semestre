...
1. *PC1 envía un mensaje RS, «Hola, acabo de arrancar. ¿Hay un enrutador IPv6 en la red? Necesito saber como obtener la información de mi dirección IPv6 de forma dinámica».*
